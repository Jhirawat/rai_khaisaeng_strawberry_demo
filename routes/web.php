...
use App\Http\Controllers\Admin\{DashboardController,ProductController,CategoryController,OrderController,PaymentController,InventoryController,UserController,ShippingController,ReportController,ThemeController,CompanySettingsController,PromotionController,ActivityLogController,ExportController,SocialLoginStatusController};
...
Route::middleware(['auth','role:staff,admin,super_admin'])->prefix('admin')->name('admin.')->group(function(){
    ...
    Route::get('exports/inventory',[ExportController::class,'inventory'])->name('exports.inventory');
    Route::get('social-login-status',[SocialLoginStatusController::class,'index'])->name('social-login-status.index');
