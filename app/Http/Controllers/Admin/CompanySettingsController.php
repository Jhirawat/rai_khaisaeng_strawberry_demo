...
class CompanySettingsController extends Controller
{
    private array $fields = [
        ...
        'company_map_url' => 'https://maps.app.goo.gl/qjemZw9EyN5zPEvr8',
    ...
    public function update(Request $request)
    {
        ...
        foreach (['site_logo_th_file','site_logo_en_file','receipt_logo_th_file','receipt_logo_en_file','site_favicon_file'] as $fileField) {
