    ...
    <div class="col-lg-5">
        ...
        <div class="content-card p-4 mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <label class="form-label">รูปพื้นหลังข้อความหน้าแรก</label>
                    <input type="file" class="form-control rounded-pill" name="home_hero_image_file" accept="image/*">
                    <div class="mt-2 border rounded-4 p-2 bg-light">
                        <img src="{{ str_starts_with($settings['home_hero_image'] ?? '', 'http') ? $settings['home_hero_image'] : asset($settings['home_hero_image'] ?? 'images/products/placeholder.svg') }}" style="max-height:120px;width:100%;object-fit:cover" alt="home hero image">
                    </div>
                    <div class="form-text">ใช้เป็นรูปหลังข้อความ “สตรอว์เบอร์รี่สดใหม่และสินค้าแปรรูปคุณภาพ” หน้าแรก</div>
                </div>
            </div>
        </div>
        <div class="content-card p-4 mb-4">
