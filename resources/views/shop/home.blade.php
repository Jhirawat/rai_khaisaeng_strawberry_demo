...
<div class="container">
    ...
    <section class="promo-strip mb-5">
        <div class="row g-0 align-items-center">
            <div class="col-lg-6 promo-img"></div>
            <div class="col-lg-6 promo-content">
                <span class="text-danger fw-bold">{{__('Promotion / Advertising Area')}}</span>
                <h2 class="fw-bold mt-2">{{__('Souvenirs from Rai Khaisaeng Strawberry Farm')}}</h2>
                <p class="text-muted">{{__('This long banner can be changed to seasonal promotions, new products, or community campaigns.')}}</p>
                <a href="{{route('shop.products')}}" class="btn btn-brand rounded-pill px-4">{{__('View Promotions')}}</a>
            </div>
        </div>
    </section>
