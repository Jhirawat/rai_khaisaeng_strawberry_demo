...
<head>
    ...
    <style>
        ...
        .btn-brand{background:var(--brand);border-color:var(--brand);color:#fff}.btn-brand:hover{background:var(--brand-dark);border-color:var(--brand-dark);color:#fff}.btn-outline-brand{border-color:var(--brand);color:var(--brand)}.btn-outline-brand:hover{background:var(--brand);color:#fff}.btn-green{background:var(--green);border-color:var(--green);color:#fff}.btn-green:hover{background:var(--green-2);border-color:var(--green-2);color:#fff}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <div class="navbar-nav align-items-lg-center">
                ...
                @else
                    <a class="nav-link" href="{{route('login')}}">{{__('Login')}}</a><a class="btn btn-sm btn-brand rounded-pill ms-lg-2" href="{{route('register')}}">{{__('Register')}}</a>
                @endauth
            </div>
        </div>
    </div>
...
<footer class="site-footer">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-3"><h5 class="fw-bold">{{__('Rai Khaisaeng Strawberry Farm')}}</h5><p class="mb-2">{{__('Rai Khaisaeng Strawberry Farm and Community Products')}}</p><p class="mb-1"><i class="bi bi-person"></i> {{__('Khun Khaisaeng')}} 089-999-8295</p><p class="mb-1"><i class="bi bi-person"></i> {{__('Khun Aoy')}} 081-033-4893</p><p class="mb-3"><i class="bi bi-person"></i> {{__('Khun Tee')}} 089-265-5686</p><a class="btn btn-outline-light px-4" href="tel:0899998295">{{__('Contact Us')}} <i class="bi bi-chevron-right"></i></a></div>
            <div class="col-lg-4"><h5 class="fw-bold">{{__('Map and Branch')}}</h5><p>{{__('Rai Khaisaeng Strawberry Farm')}} {{__('Bo Kaeo Subdistrict, Samoeng District, Chiang Mai')}}</p><iframe class="footer-map mb-2" loading="lazy" src="https://www.google.com/maps?q=%E0%B8%9A%E0%B9%89%E0%B8%B2%E0%B8%99%E0%B9%81%E0%B8%A1%E0%B9%88%E0%B8%A2%E0%B8%B2%E0%B8%87%E0%B8%AB%E0%B9%89%E0%B8%B2%20%E0%B8%AA%E0%B8%B0%E0%B9%80%E0%B8%A1%E0%B8%B4%E0%B8%87%20%E0%B9%80%E0%B8%8A%E0%B8%B5%E0%B8%A2%E0%B8%87%E0%B9%83%E0%B8%AB%E0%B8%A1%E0%B9%88&output=embed"></iframe><a target="_blank" href="https://maps.app.goo.gl/qjemZw9EyN5zPEvr8"><i class="bi bi-map me-2"></i> {{__('Open Google Maps')}}</a></div>
