...
use App\Models\{User,Category,Product,Inventory,ProductImage};
...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // v22-23 Demo Production Database: สินค้า รูปสินค้า ผู้ใช้ ออเดอร์ ยอดขาย สต็อก สลิป และรีวิวแบบสมจริง
